...
def mobilenet_v1(pretrained):
    model = MobileNetV1(n_class=1000,  profile='normal')
    if pretrained:
        weight = torch.load("/data/workspace/cluster-compression/benchmarks/logs/imagenet/pretrain/mobilenet_imagenet.pth.tar",map_location='cpu')['state_dict']
